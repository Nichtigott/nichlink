...
pub(super) struct ModuleFaceValues<'a> {
    ...
    pub(super) expected_output: &'a str,
    pub(super) actual_output: &'a str,
...
impl<'a> ModuleFaceValues<'a> {
    ...
    pub(super) fn from_new(face: &NewModuleFace<'a>) -> Self {
        Self {
            ...
            expected_output: face.expected_output,
            actual_output: face.actual_output,
    ...
    pub(super) fn from_patch(patch: &ModuleFacePatch<'a>) -> Self {
        Self {
            ...
            registry_name: patch.registry_name,
            ...
            expected_output: patch.expected_output,
            actual_output: patch.actual_output,
